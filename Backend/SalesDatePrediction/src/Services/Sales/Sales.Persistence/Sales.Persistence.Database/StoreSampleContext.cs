...
namespace Sales.Persistence.Database;
...
public partial class StoreSampleContext : DbContext
{
    ...
    public virtual DbSet<GetClientOrder> GetClientOrders { get; set; }

    public virtual DbSet<GetSalesDatePrediction> GetSalesDatePredictions { get; set; }

    public virtual DbSet<GetShipper> GetShippers { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<GetClientOrder>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("GetClientOrders", "Sales");
		...
		{
			modelBuilder.Entity<GetClientOrder>()
				.HasKey(e => e.Orderid); // Solo para InMemory
		}

		modelBuilder.Entity<GetSalesDatePrediction>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("GetSalesDatePrediction", "Sales");

			entity.Property(e => e.custid).HasColumnName("custid");
			entity.Property(e => e.CustomerName).HasMaxLength(40);
            entity.Property(e => e.LastOrderDate).HasColumnType("datetime");
            entity.Property(e => e.NextPredictedOrder).HasColumnType("datetime");
        });
		if (Database.ProviderName == "Microsoft.EntityFrameworkCore.InMemory")
		{
			modelBuilder.Entity<GetSalesDatePrediction>()
				.HasKey(e => e.custid); // Solo para InMemory
		}

		modelBuilder.Entity<GetShipper>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("GetShippers", "Sales");
		...
		if (Database.ProviderName == "Microsoft.EntityFrameworkCore.InMemory")
		{
			modelBuilder.Entity<GetShipper>()
				.HasKey(e => e.Shipperid); // Solo para InMemory
		}

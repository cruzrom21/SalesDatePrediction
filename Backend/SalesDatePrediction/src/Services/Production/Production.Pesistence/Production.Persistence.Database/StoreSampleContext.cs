...
namespace Production.Persistence.Database;
...
public partial class StoreSampleContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<GetEmployee>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("GetEmployees", "HR");

            entity.Property(e => e.Empid).ValueGeneratedOnAdd();
            entity.Property(e => e.FullName).HasMaxLength(31);
        });
		...
		{
			modelBuilder.Entity<GetProduct>()
				.HasKey(e => e.Productid); // Solo para InMemory
		}
